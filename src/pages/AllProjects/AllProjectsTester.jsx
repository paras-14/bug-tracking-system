...
import { getAllProjectsTesterNdeveloper } from '../../redux/slices/projectSlice';
...
const AllProjectsLeader = () => {
  ...
  useEffect(() => {
    dispatch(getAllProjectsTesterNdeveloper())
  }, [])
  ...
  return ( 
      <div >
        <div>
          <h1>Here Are All The Projects Tester And Developer</h1>
        </div>
